    ...
    <div className=" w-full p-4 sm:p-8 " id="home">
      <div className="h-full mx-auto text-center flex flex-col gap-y-8">
        ...
        <p className="w-full text-sm sm:max-w-lg text-slate-600 tracking-wider mx-auto">
          ...
          eius earum facilis! Sit, atque distinctio sint laborum a ipsa nostrum
          doloremque possimus? Esse sed vel ut asperiores incidunt. Iste non
          facilis tempora est, quod odit fugit vel obcaecati deleniti quis
          corporis, quaerat inventore aliquam. Aperiam commodi nesciunt eius
          modi
        </p>
        <button
          type="button"
